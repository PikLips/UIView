 ...
 */
#define AUTORESIZINGMASK_VIEWDEFAULT                (UIViewAutoresizing) UIViewAutoresizingFlexibleHeight | UIViewAutoresizingFlexibleWidth
...
#define BACKGROUNDCOLOR_DEFAULT                     [UIColor colorWithRed: (CGFloat) 1.0 green: (CGFloat) 1.0 blue:(CGFloat) 1.0 alpha: (CGFloat) 1.0]
...
#define SUBVIEWSCOUNT_DEFAULT                       (NSUInteger) 1
/* PikLips:
 * user specified
...
#define TAG_DEFAULT                                 (NSInteger) 0
